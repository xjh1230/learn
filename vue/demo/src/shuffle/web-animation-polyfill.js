...
!(function() {
    ...
    !(function(a, b) {
        ...
        function e() {
            return a.isDeprecated(
                ...
                "2016-03-02",
                "TypeError exceptions will be thrown instead.", !0
            );
        }
    ...
    (function() {
        ...
        (function(a, b) {
            function c(a, b) {
                return (!(!b.namespaceURI || -1 == b.namespaceURI.indexOf("/svg")) &&
                    (g in a ||
        ...
        (function(a) {
            function b(a, b) {
                ...
                if (c)
                    return (
                        (c = a.ignoreCase ? c[0].toLowerCase() : c[0]), [c, b.substr(c.length)]
                    );
            }
            ...
            function e(a, b) {
                for (
                    var c = 0, d = 0; d < b.length && (!/\s|,/.test(b[d]) || 0 != c); d++
                )
                    if ("(" == b[d]) c++;
            ...
            function j(a, b, c, d, e) {
                for (
                    var g = [], h = [], i = [], j = f(d.length, e.length), k = 0; k < j; k++
                ) {
            ...
            function d(b, c) {
                ...
                if (b.inset == c.inset && !!b.color == !!c.color) {
                    ...
                    return [
                        ...
                        function(a) {
                            for (
                                var c = b.inset ? "inset " : " ", f = 0; f < e.length; f++
                            )
                                c += e[f](a[0][f]) + " ";
                            return d && (c += d(a[1])), c;
                        },
        ...
        (function(a, b) {
            ...
            var k = null,
                ...
                n = {
                    matrix: [
                        "NNNNNN", [k, k, 0, 0, k, k, 0, 0, 0, 0, 1, 0, k, k, 0, 1],
                        d,
                    ],
